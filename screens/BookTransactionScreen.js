...
export default class TransactionScreen extends React.Component {
    ...
    initiateBookIssue = async()=>{
      ...
      db.collection("books").doc(this.state.scannedId).update({
        "bookAvail": false
      })
      db.collection("students").doc(this.state.scannedId).update({
        "numberofissue": firebase.firestore.FieldValue.increment(1)
      })
    }
